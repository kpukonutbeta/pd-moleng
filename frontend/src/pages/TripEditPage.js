...
export default function TripEditPage() {
  ...
  const fetchTrip = async () => {
    try {
      ...
      setForm({
        ...
        dasar_perjalanan: res.data.dasar_perjalanan,
        maksud_tujuan: res.data.maksud_tujuan,
      });
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Gagal memperbarui perjalanan');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-3xl mx-auto animate-fade-in">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-2">
            Perbarui informasi perjalanan dinas Anda
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  data-testid="edit-trip-judul-input"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className="input-field"
                  data-testid="edit-trip-tujuan-input"
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    className="input-field"
                    data-testid="edit-trip-tanggal-mulai-input"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    className="input-field"
                    data-testid="edit-trip-tanggal-selesai-input"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className="input-field"
                  data-testid="edit-trip-dasar-input"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  data-testid="edit-trip-maksud-input"
                />
              </div>
              ...
              <div className="pt-4 flex gap-3">
                <Button
                  ...
                  variant="outline"
                  onClick={() => navigate(`/trips/${id}`)}
                  data-testid="cancel-edit-trip-btn"
                >
                  Batal
                </Button>
                <Button
                  ...
                  disabled={loading}
                  data-testid="submit-edit-trip-btn"
                >
